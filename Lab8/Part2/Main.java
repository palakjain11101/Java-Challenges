...
public class Main{
	...
	public static void main(String[] args){
		...
		//Prints out animals names and ages before ordering
		System.out.println("List before the use of" + "Collection.sort() :\n" + list);
		
		//animals are ordered from the lowest to the highest age 
		Collections.sort(list);

		//animals are now ordered from highest age to lowest age
