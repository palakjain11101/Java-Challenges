...
class QuizTest {
	...
	void allRight() {
		...
		assertTrue(out.contains("By what initials was Franklin Roosevelt better known"), "should ask questions1");
		assertTrue(out.contains("At what age did Franklin Roosevelt die"), "should ask questions2");
